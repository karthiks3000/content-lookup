...
export class EidrComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.subs = this.globalService.searchTerm$.debounceTime(300).distinctUntilChanged().subscribe(str =>
  ...
  ngOnDestroy(): void {
    ...
    console.log('subscription killed');
  }
